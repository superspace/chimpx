...
// campaigns grid
$_lang['chimpx.tab_campaigns'] = 'All your campaigns';

$_lang['chimpx.campaign'] = 'campaign';
$_lang['chimpx.campaigns'] = 'campaigns';
...
$_lang['chimpx.campaign_url_desc'] = 'Resource to be used as HTML content for this campaign.<br />
...
$_lang['chimpx.campaigntype_combo_regular_desc'] = 'Normal campaign type, sending multipart emails (HTML + text)';
...
// lists grid
$_lang['chimpx.tab_lists'] = 'All your lists';
...
$_lang['chimpx.list_overview'] = 'List overview: ';
$_lang['chimpx.list_tab_details'] = 'List details';
$_lang['chimpx.list_tab_mergevars'] = 'Merge tags';
$_lang['chimpx.list_tab_mergevars_desc'] = 'Here is the list of merge tags for your MailChimp list, including their name, tag, and required setting';
$_lang['chimpx.list_tab_subscribers'] = 'Subscribers';
$_lang['chimpx.list_tab_subscribers_desc'] = 'The list of people subscribed to this MailChimp list';

$_lang["chimpx.mergevar_create"] = 'Create a new merge tag';
$_lang["chimpx.mergevar_update"] = 'Update selected merge tag';
...
// MailChimp helper
$_lang['chimpx.ping_error'] = 'Seems like something went bad on MailChimp\'s side. Here is the answer we get:<br />[[+response]]<br /><br />For more informations, you may want to check:<br /><a href="https://twitter.com/mailchimpstatus" target="_blank">@mailchimpstatus</a><br /><a href="http://status.mailchimp.com/" target="_blank">status.mailchimp.com</a>';
$_lang['chimpx.ping_error_title'] = 'Uhoh!';
$_lang['chimpx.ping_ok'] = '[[+response]]<br />Understand everything is fine on Mailchimp\'s side.';
$_lang['chimpx.ping_ok_title'] = 'All good!';

// Subscribers
$_lang['chimpx.subscriber_status_subscribed'] = 'Subscribed';
